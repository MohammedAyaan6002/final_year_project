                    ...
                    <form class="needs-validation" id="foundForm" novalidate enctype="multipart/form-data">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" name="finder_email" pattern="^[a-zA-Z0-9._%+-]+@gmail\.com$" required>
                                <div class="invalid-feedback">Email must end with @gmail.com.</div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Phone</label>
                                <input type="text" class="form-control" name="finder_phone" pattern="[0-9]{10}" maxlength="10" required>
